...
protected:
    ...
    real starting_alpha;
    int alpha_divide;
    double logp, llogp, lllogp;
	double vlogp, vllogp;//prnnlm
	double ppl, lppl, llppl;//prnnlm
    ...
    struct neuron *neuvb;
	struct neuron *neuvhb;
    struct neuron *neuvvb;
    struct synapse *syn2b;
    struct synapse *syn3b;
    struct synapse *syn4b;
	struct synapse *syn5b;
	struct synapse *syn6b;
	struct synapse *syn7b;
	struct synapse *syn8b;
	
	bool use_gold_pos=false;
    //end prnnlm
...
public:
    ...
    //prnnlm
    void setVariableSize(int newsize) {var_size=newsize; varh_size=newsize/5;}
    //end prnnlm
	...
	void saveVarWeights();			//saves current weights and unit activations
    void restoreVarWeights();		//restores current weights and unit activations from backup copy
    ...
    void computeNet(int last_word, int word, bool test);	//prnnlm
